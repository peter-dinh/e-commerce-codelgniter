<?php 
    class Product extends MY_Controller
    {
        ...
        function catalog()
        {
            ...
            //hiển thị ra view
            $this->data['content'] = 'site/product/catalog';
        ...
        function view()
        {
            ...
            $this->data['total_comment'] = $this->comment_model->get_total($input);
            
            if($this->session->userdata('login'))
                $this->data['login_user'] = 1;
            else
                $this->data['login_user'] = 0;
                
            //hiển thị ra view
            $this->data['content'] = 'site/product/view';
            $this->load->view('site/layout', $this->data);
        }
        ...
        function search()
        {
            ...
            if($this->uri->rsegment('3') == 1)
            {
                ...
                //load view
                $this->data['content'] = 'site/product/search';
                $this->load->view('site/layout', $this->data);
            }
        }
        ...
        function search_price()
        {
            ...
            //load view
            $this->data['content'] = 'site/product/search_price';
            $this->load->view('site/layout', $this->data);
        }
    }
?>