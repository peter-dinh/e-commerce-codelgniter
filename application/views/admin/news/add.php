<section class="content">
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <form class="form-horizontal" method="post" action="<?php echo admin_url('news/add'); ?>" enctype="multipart/form-data" >
                    <div class="box-header">
                        <h4>Thêm sản bai viet</h4>
                    </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="info">
                                    <div class="form-group">
                                        <label for="inputTitle" class="col-sm-2 control-label">Tieu de:</label>
                            
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="inputTitle" id="inputTitle" placeholder="Tên sản phẩm">
                                    ...
                                    <div class="form-group">
                                        <label for="inputIntro" class="col-sm-2 control-label">Gioi thieu:</label>
                    
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="inputIntro" id="inputIntro" placeholder="Title"></textarea>
                                        </div>
                                    </div>
                    ...
                    <div class="box-footer">
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                              <button type="submit" name="submit" class="btn btn-danger pull-right">Thêm bai viet</button>
                            </div>
                        </div>
                    </div>
                </form>
