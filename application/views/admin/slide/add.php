<section class="content">
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <form class="form-horizontal" method="post" action="<?php echo admin_url('slide/add'); ?>" enctype="multipart/form-data" >
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="info">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="inputName" id="inputName" placeholder="Tên Slide">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="inputInfo" id="inputInfo" placeholder="Mô tả">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="inputSort" id="inputSort" placeholder="Vị trí">
                    ...
                    <div class="box-footer">
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                              <button type="submit" name="submit" class="btn btn-danger pull-right">Thêm Slide</button>
                            </div>
                        </div>
                    </div>
                </form>
