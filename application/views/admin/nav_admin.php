    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>N</b>ora</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Nora</b> Shop</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo admin_url('admin/logout'); ?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
