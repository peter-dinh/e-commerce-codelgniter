    ...
    <title>Nora Shop | Dashboard</title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="<?php echo base_url() ?>/public/admin/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>/public/admin/bootstrap/css/bootstrap-theme.min.css">
    <!-- Font Awesome -->
    ...
    <!-- jQuery 3.1.1 -->
    <script src="<?php echo base_url() ?>/public/admin/plugins/jQuery/jquery-3.1.1.min.js"></script>
    <!-- jQuery UI 1.11.4 -->
